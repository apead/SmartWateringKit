...
// Parameter States
bool property_state_change = true;
...
void SendTelemetry()
{
  String sMoisture1 = "TMoisture1:";
  sMoisture1.concat(moisture1_value);

  String sMoisture2 = "TMoisture2:";
  sMoisture2.concat(moisture2_value);

  String sMoisture3 = "TMoisture3:";
  sMoisture3.concat(moisture3_value);

  String sMoisture4 = "TMoisture4:";
  sMoisture4.concat(moisture4_value);



  String sOutstring = sMoisture1 + "#" + sMoisture2 + "#" + sMoisture3 + "#" + sMoisture4 + "#";
  Serial1.write(sOutstring.c_str());
  Serial1.flush();
  delay(500);

  if (property_state_change)
  {
    String sRelay1 = "PRelay1State:";
    sRelay1.concat(relay1_state_flag);

    String sRelay2 = "PRelay2State:";
    sRelay2.concat(relay2_state_flag);

    String sRelay3 = "PRelay3State:";
    sRelay3.concat(relay3_state_flag);

    String sRelay4 = "PRelay4State:";
    sRelay4.concat(relay4_state_flag);

    String sPump = "PPumpState:";
    sPump.concat(pump_state_flag);

    sOutstring = sRelay1 + "#" + sRelay2 + "#";
    Serial1.write(sOutstring.c_str());
    Serial1.flush();
    delay(500);
    sOutstring = sRelay3 + "#" + sRelay4 + "#";
    Serial1.write(sOutstring.c_str());
    Serial1.flush();
